...
class RankingArtigosVisitadosController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        foreach ($rankings as $ranking) {
            $pontuaçao = $ranking->artigos_visitados;
        ...
        print_r($dicionarios);
        return view('rankingArtigosVisitados', compact('rankings', 'dicionarios'));
    }
